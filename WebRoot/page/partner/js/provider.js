...
$(function() {
	...
	function initData() {
		...
		$.ajax({
			type : "post",
			url : templateRoot + 'partner/Partner_listProvider.action',
			data : {
				"currPage" : currPage
			},
			dataType : "json",
	...
	$("#testB").click(function() {
		$.ajax({
			type : "post",
			url : templateRoot + 'partner/Partner_partnerTest.action',
			dataType : "json",
			cache : false,
			success : function(data, textStatus) {
				hAlert(data.message);
	...
	function addDialog() {
		$("#providerForm").clearForm();
		$("#addDialog").dialog("option", "title", "新建供货商信息").dialog("open");
		openInput();
	}

	// 弹出修改窗口
	function updateDialog(id) {
		$("#addDialog").dialog("option", "title", "修改供货商信息").dialog("open");
		openInput();
		$.ajax({
			type : "post",
	...
	$.fn.showDetail = function(id) {
		$("#addDialog").dialog("option", "title", "查看供货商信息").dialog("open");
		disableInput();
		$.ajax({
			type : "post",
			url : templateRoot + 'partner/Partner_getById.action',
